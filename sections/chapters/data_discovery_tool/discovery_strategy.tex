...
\begin{itemize}
    \item Longest Continuous (Matching) Subsequence (LCS), as implemented by the Python \textit{difflib} library
    \item The Levenshtein distance, as implemented by the Python \textit{Levenshtein} library
    \item The Wu-Palmer Similarity, as implemented by the Python Natural Language Toolkit (NLTK)
\end{itemize}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth, angle=270]{figures/names_lcs_levenshtein_wordnet_table}
